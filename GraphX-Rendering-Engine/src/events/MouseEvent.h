...
namespace engine
{
	...
	public:
		...
		EVENT_CLASS_CATEGORY(GX_EVENT_CATEGORY_MOUSE | GX_EVENT_CATEGORY_INPUT)
	};
	...
	public:
		...
		EVENT_CLASS_CATEGORY(GX_EVENT_CATEGORY_MOUSE | GX_EVENT_CATEGORY_MOUSE_BUTTON | GX_EVENT_CATEGORY_INPUT)
	};
